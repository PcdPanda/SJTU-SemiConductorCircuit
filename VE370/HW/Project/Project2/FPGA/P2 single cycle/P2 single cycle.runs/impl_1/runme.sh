...
HD_PWD='D:/PANDA/Study/VE370/Project/Project2/FPGA/P2 single cycle/P2 single cycle.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log SingleCycle.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source SingleCycle.tcl -notrace
