...
HD_PWD='D:/PANDA/Study/VE370/Project/Project2/FPGA/P2 single cycle/P2 single cycle.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log SingleCycle.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source SingleCycle.tcl
