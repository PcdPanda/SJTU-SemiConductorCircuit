...
HD_PWD='D:/PANDA/Study/VE370/HW/HW3_9/HW3_9.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log HW3_3.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source HW3_3.tcl
